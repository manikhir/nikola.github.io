...
BLOG_AUTHOR = "manisha"  # (translatable)
BLOG_TITLE = "postcards.vprojects.us"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://postcards.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://postcards.com/"
BLOG_EMAIL = "manisha.k@cisinlabs.com"
BLOG_DESCRIPTION = "postcard"  # (translatable)
